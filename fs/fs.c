...
// Optimization opportunity: After you read a block from disk, the processor's
//   VM hardware will mark the corresponding page as dirty (PTE_D).
//   Is the page truly dirty?  What will happen if you leave it marked dirty?
static int
...
//	-E_INVAL if filebno is out of range (it's >= NINDIRECT + NDIRECT).
//
